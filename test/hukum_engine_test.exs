defmodule HukumEngineTest do
  ...
  test "choosing and confirming teams" do
    ...
    assert HukumEngine.choose_team(via("GAME3"), :player1, 1) == :ok
    assert HukumEngine.choose_team(via("GAME3"), :player2, 1) == :ok
    assert HukumEngine.choose_team(via("GAME3"), :player3, 1) == { :error, :team_full }
    assert HukumEngine.choose_team(via("GAME3"), :player3, 2) == :ok
    assert HukumEngine.confirm_teams(via("GAME3")) == { :error, :teams_not_filled }
    assert HukumEngine.choose_team(via("GAME3"), :player4, 2) == :ok
